...
// Database Connection
const MONGODB_URI = 'mongodb+srv://vivekgarg0605:06062005@business.kyssclv.mongodb.net/ApnaBazar';
...
app.listen(PORT, () => {
  console.log(`🚀 Apna Bazarr Backend running on http://localhost:${PORT}`);
