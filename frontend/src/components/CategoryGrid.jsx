    ...
    <section className="py-12 bg-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-6">
          ...
          <div className="lg:col-span-5 relative group overflow-hidden rounded-3xl bg-gradient-to-r from-rose-900 to-rose-950 p-8 min-h-[380px] sm:min-h-[440px] flex flex-col justify-between shadow-md hover:shadow-xl transition-shadow text-white">
            ...
            <div className="relative z-10 pt-4">
              <button
                ...
                className="px-6 py-3 bg-amber-400 hover:bg-amber-500 text-slate-950 text-xs font-black uppercase tracking-wider rounded-xl transition-colors shadow-md"
              >
                Shop Sister Gifts
              </button>
            </div>
          ...
          <div className="lg:col-span-7 flex flex-col justify-between space-y-6">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
              ...
              {/* Gold Clutch & Handbag Card (Matching Photo 2) */}
              <div className="relative group overflow-hidden rounded-3xl bg-[#eaddca] p-6 min-h-[200px] flex flex-col justify-between shadow-xs hover:shadow-md transition-shadow">
                ...
                <div className="relative z-10 pt-4">
                  <button
                    ...
                    className="text-xs font-black text-slate-900 group-hover:text-rose-700 flex items-center space-x-1 transition-colors"
                  >
              ...
              {/* Rakhi Luxury Hampers & Watches (Matching Photo 3) */}
              <div className="relative group overflow-hidden rounded-3xl bg-slate-900 p-6 min-h-[200px] flex flex-col justify-between shadow-xs hover:shadow-md transition-shadow text-white">
                ...
                <div className="relative z-10 pt-4">
                  <button
                    ...
                    className="text-xs font-black text-amber-300 group-hover:text-white flex items-center space-x-1 transition-colors"
                  >
            ...
            <div className="relative group overflow-hidden rounded-3xl bg-amber-900 p-6 sm:p-8 min-h-[200px] flex flex-col justify-between shadow-xs hover:shadow-md transition-shadow text-white">
              <img
              ...
              <div className="relative z-10 pt-4">
                <button
                  ...
                  className="text-xs font-black text-amber-300 group-hover:text-amber-400 flex items-center space-x-1 transition-colors"
                >
